<?php
    ...
    $baza = new Baza();
    $baza->spojiDB();
    $broj_redova = count($baza->dohvati_moderatore(999999999, 0, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje));
    ...
    $tablica = $baza->dohvati_moderatore($limit, $offset, $atribut_za_sortiranje, $smjer_sortiranja, $atribut_za_pretrazivanje, $vrijednost_za_pretrazivanje);
    $baza->zatvoriDB();
